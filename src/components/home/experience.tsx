...
export function Experience(props: IIntroProps) {
  return (
    <section
      ...
      data-aos-delay={300}
    >
      <div className="flex gap-10 px-10 flex-col lg:flex-row ">
        <img src="/assets/images/about/about.png" className="hidden md:block" />
        <div className="font-bold leading-none flex flex-wrap flex-col gap-y-2">
          ...
          <p className="paragraph pr-10">
            ...
            maintainable code and intuitive user interfaces. My focus is on web
            development, problem-solving, and integrating the latest
            technologies to create scalable, efficient solutions. I am a website
            beauty maker.
          </p>
