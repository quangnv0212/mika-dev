...
export interface IHeroSectionStartProps {}

export function HeroSectionStart(props: IHeroSectionStartProps) {
      ...
      <div className="container">
        <div className="grid grid-cols-1 2xl:-mx-4">
          <div className="xl:pt-12">
            <span
              className="text-black-800 font-bold text-2xl lg:text-[32px] leading-none flex flex-wrap items-center mb-3"
              data-aos="fade-right"
              data-aos-delay={300}
            >
              <span className="mr-6">
            ...
            <h2
              className="text-black-800 font-bold text-[80px] lg:text-[100px] xl:text-[120px] 2xl:text-[140px] leading-[64px] lg:leading-[80px] xl:leading-[90px] 2xl:leading-[110px] mb-[20px]"
              data-aos="fade-right"
              data-aos-delay={600}
            >
              Vu
            ...
            <p
              className="text-black-700 font-bold text-lg md:text-xl xl:text-2xl leading-tight mb-[30px]"
              data-aos="fade-right"
              data-aos-delay={800}
            >
              Software Developer | Based in Hanoi 🇻🇳
            </p>
            ...
            >
              <div className="flex flex-wrap items-center">
                <span className=" text-black-800 font-bold text-[44px] leading-none">
                  <span>{counter}+</span>
                </span>
